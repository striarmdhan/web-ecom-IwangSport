            ...
            <table class="w-full">
              ...
              <tbody>
                ...
                <tr wire:key='{{$item['id']}}'>
                  ...
                  <td><button wire:click='removeItem({{$item['id']}})' class="bg-slate-300 border-2 border-slate-400 rounded-lg px-3 py-1 hover:bg-red-500 hover:text-white hover:border-red-700"><span wire:loading.remove wire:target='removeItem({{$item['id']}})'>Remove</span><span wire:loading wire:target='removeItem({{$item['id']}})'>Removing....</span></button></td>
                </tr>
                @empty
                  <tr>
                    <td colspan="5" class="text-center py-4 text-4xl font-semibold text-slate-500">Keranjang Kosong</td>
                  </tr>
                @endforelse
